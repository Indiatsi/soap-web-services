...
$result = array();	
$response = '';
$wsdl = "http://localhost/AssignmentThree/soap_server.php?wsdl";
  	...
  	<div class='row'>
  		<form class="form-inline" method = 'post' name='form1'>
	    	...
	    	<div class="form-group">
	      		...
	      		<input type="text" class="form-control" name="admission" id="admission" placeholder="Admission Number" required>
	    	</div>
  	...
  	<form class="form-inline" method = 'post' name='form1'>
	    ...
	    <div class="form-group">
	      ...
	      <input type="text" class="form-control" name="name" id="name" placeholder="Student Name" required>
				...
				<input type="text" class="form-control" name="points" id="points" placeholder="Entry Points" required>
	    </div>
